            ...
            <Section no_border={true} bs_classes={"mb--5"}>
                <div className={"row"}>
                    <div className="col-lg-10 col-sm-12">
                        ...
                        <p className="fs-5"> Tortoise is a community of Beginner to Advanced programmers focusing on Python.<br/>
                            ...
                            or contribute to open source projects, all of that is welcome here.
                        </p>
                    </div>
                </div>
            </Section>
